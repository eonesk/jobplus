...
#second_searchJobDiv1 {left: 429px; width: 299px; overflow-y: scroll;}
#second_searchJobDiv2 {left: 129px; width: 900px; border-top: 1px solid black;}
