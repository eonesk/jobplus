...
#second_searchJobDiv1 {left: 309px; width: 299px; overflow-y: scroll;}
#second_searchJobDiv2 {left: 9px; width: 900px; border-top: 1px solid black;}
...
#searchResultList {position: absolute; left: 300px; padding-top: 80px;}
...
<script type="text/javascript">
	$(function() {
		...
		console.log("cpm_id값 = " + cpm_id + "//" + "m_id값 = " + m_id);
		...
		$("#main_Tbutton1").on(
				"click",
				function() {
					window.open("../main/rmViewForm.jsp", "",
...
<input type="hidden" id="Main_M_id" class="Main_M_id" value="${sessionScope.m_id}">
	<div id="container">
		<header id="header">
			...
			<!-- fixed SearchBar -->
			<div id="fixedSearchBar" style="position: absolute; z-index: 700px; top: 90px; left: 195px; background: red;">
					<form action="../mainSearch/searchR.do" name="searchInfo">
				 		<div id="main_searchJobDiv">
				 			<div id="searchTextDiv">
				 				<img src="/job/img/keyword.png">
				 				<input id="searchText" type="text" maxlength="30" placeholder="회사명 입력" name="searchCompany">
				 			</div>
				 			<div id="searchRegionDiv">
				 				<img src="/job/img/region.png">
				 				<span id="regionPlaceholder"
				 						style="">지역 선택</span>
				 			</div>
				 			<div id="searchJobDiv">
				 				<img src="/job/img/jobsearch.png" style="margin-left: 5px;">
		...
		<section id="cm_contents">
		 	<div id="main_select" class="main_select">
		 		...
		 		<!-- ------------------------------------------ SEARCHPART ---------------------------------------------------------------------- -->
				<div id="searchDataInfo" style="position: relative; left: -500px; top: 130px;">
					
					<div style="padding: 5px;">
						<span style="font-size: 30px; color: #5882FA;">회사명 : </span>
						<span style="font-size: 30px; color: gray;">${param.searchCompany}</span>
					</div>
					<div style="position: absolute; left: 920px; padding: 5px;">
						<span style="font-size: 30px; color: #5882FA;">지역 : </span>
						<span style="font-size: 30px; color: gray;">
							<c:forEach var="region" items="${ searchRegion }">
					 			${ region }
					 		</c:forEach>
						</span>
					</div>
					<div style="position: absolute; top: 100px; left: 920px; padding: 5px;">
						<span style="font-size: 30px; color: #5882FA;">업종 : </span>
						<span style="font-size: 30px; color: gray;">
							<c:forEach var="workspace" items="${ jobSelect3 }">
					 			${ workspace }
					 	</c:forEach>
						</span>
					</div>
