...
#conditionBusinessInputDiv {display: inline-block; border: 1px solid #b0b0b0; border-radius: 3px; /* position: relative; left: 200px;  */width: 598px; height: 80px; margin-top: 10px;}
...
#conditionAddrMap {
	...
	border-radius: 3px; width: 578px; height: 480px;
	padding-left: 20px;
}
			...
			<div id="conditionWorkspaceRight">				
				...
				<div id="conditionWorkspaceMap">
					...
					<div id="conditionAddrMap">
						<h4>위치/지도 확인&nbsp;&nbsp;|&nbsp;&nbsp;</h4><span id="addrShow"></span>
						<br>
