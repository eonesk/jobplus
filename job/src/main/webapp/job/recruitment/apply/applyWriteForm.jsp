...
<body class="write">
	...
	<p><span>&lowast;학력</span>
		<!-- <input type="number" min="0" max="100" id="rmi_Personnel" class="rmi_Personnel"> 명 -->
		<input type="radio" id="Type_radio_x" class="Type_radio" name="Type_radio" value="0" checked> 학력무관 
  		<input type="radio" id="Type_radio_o" class="Type_radio" name="Type_radio" value="1"> 제한 
  		...
  		<input type="checkbox" id="" class="" >졸업예정자 가능 </p>
		<hr>
	<p class="p3">전공학과 	
  		<input type="text" id="rma_Major" class="Type_radio" name="Type_radio" value="1"> 입력  </p>
