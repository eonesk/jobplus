	...
	<div id="rmp_content" class="rmp_content">
		<div id="rmp_lineOne" class="rmp_lineOne">
			...
			<div id="rmp_lineOneContent" class="rmp_lineOneContent">
				<label for="rmp_name" id="rmp_nameLabel" class="rmp_mustLabel rmp_inputLabel rmp_nameLabel">이름</label>
				<input type="text" id="rmp_name" class="rmp_name">
				<label for="rmp_dept" id="rmp_deptLabel" class="rmp_inputLabel rmp_deptLabel">담당부서</label>
		...
		<div id="rmp_lineTwo" class="rmp_lineTwo">
			...
			<div id="rmp_lineTwoContent" class="rmp_lineTwoContent">
				<div id="" class="rmp_lineTwoContentDiv">
					<label class="rmp_mustLabel rmp_inputLabel">전화</label>
					<input type="text" class="rmp_tel1 rmp_inputTel">-
					<input type="text" class="rmp_tel2 rmp_inputTel">-
					<input type="text" class="rmp_tel2 rmp_inputTel">
					<label class="rmp_inputLabel">내선번호</label>
					<input type="text" class="rmp_inputTel">
				</div>
				<div id="" class="rmp_lineTwoContentDiv">
					<label class="rmp_mustLabel rmp_inputLabel">휴대폰</label>
					<input type="text" class="rmp_tel1 rmp_inputTel">-
					<input type="text" class="rmp_tel2 rmp_inputTel">-
					<input type="text" class="rmp_tel2 rmp_inputTel">
				</div>
				<div id="" class="rmp_lineTwoContentDiv">
					<label class="rmp_mustLabel rmp_inputLabel">e메일</label>
					<input type="text" id="rmp_inputEmail1" class="rmp_inputEmail">@
					<input type="text" id="rmp_inputEmail2" class="rmp_inputEmail">
					<select id="rmp_selectEmail" class="rmp_selectEmail">
				...
				<div id="" class="rmp_lineTwoContentDiv rmp_linTwoP">
					※e메일을 통해 허위입사지원의 사례가 발생되고 있습니다.
					<br>사람인 온라인접수 선택 후 e메일을 비공개로 등록해주시면 악용되는 경우가 방지됩니다.
				</div>
			</div> 
		</div>
	</div>
