	...
	<h2>희망근무조건</h2>
		<div class="working_conditions_item1">
			...
			<span class="rs_pay">	
				...
				<input type="checkbox" value="면접 후 결정" id="rs_pay_no" class="rs_pay_no" name="rs_pay_no" class="checkbox rs_pay_no"><label for="rs_pay_no">면접 후 결정</label>
			</span>
		</div>	
		<table>
			<tr>
				<td colspan="2">
					<div class="header">
						...
						<div class="right">
							<input type="button" id="rs_workspace_btn" class="button" value="추가하기">
