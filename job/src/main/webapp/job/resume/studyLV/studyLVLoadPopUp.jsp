				...
				if(data == "0") {
					...
					$.ajax({
						...
						success: function(data) {
							...
							var tdTitle = $("<td>").addClass("studyLVLoadListLabelTd").html("&nbsp;");
...
<style type="text/css">
	#rss_UserTitleA:link {color: black; text-decoration: none;}
	#rss_UserTitleA:visited {color: black; text-decoration: none;}
	#rss_UserTitleA:hover {color: #5882FA; text-decoration: underline;}
</style>
</head>
<body>
	<h3>학력정보 불러오기</h3>
	...
	<div style="width: 500px; height: 150px; overflow-y: scroll; overflow-x: hidden;">
		<table id="studyLVLoadListTable" name="studyLVLoadListTable">
		<!-- 자기소개서 List 들어갈 부분 -->
		</table>
	</div>
	<br>
	<div style="background: #f5f7fb; padding: 10px; padding-top: 2px; height: 250px; overflow-x: scroll;" id="studyLVLoadView">
		<div style="text-align: center;" id="studyLVLoadViewInit">
			<p style="font-size: 14px; margin: 80px;">
				위 목록에서 학력정보를 선택하신 후,<br>
				<strong style="color: #566feb; font-weight: bold;">[학력정보 불러오기]</strong> 버튼을 클릭하여 불러오기 하거나<br>
				또는 필요한 <strong style="color: #566feb; font-weight: bold;">부분</strong>을 복사하여<br>
				작성중인 <strong style="color: #566feb; font-weight: bold;">학력정보에 붙여넣기</strong> 해주세요.</p>
		</div>	
	</div>
	<p style="font-size: 10px;">[학력정보 불러오기]를 클릭하시면, 선택하신 학력정보 내용과 양식(폼)이 불러오기 됩니다.</p>
	<div align="center">
